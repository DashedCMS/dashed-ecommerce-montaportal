                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('order-montaportal-track-and-trace-email-title', 'montaportal', 'Dear :name:', 'text', [
'name' => $order->name
])}}
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br>
                                                                    {!! Translation::get('order-montaportal-track-and-trace-email-content', 'montaportal', 'Your order has been picked. The following track and trace code(s) are available.', 'editor') !!}
                                                                    <hr>
                                                                    @foreach($montaPortalOrder->track_and_trace_links as $url)
                                                                        <a href="{{$url}}">{{$url}}</a>
                                                                    @endforeach
                                                                </div>
                                                            </td>
